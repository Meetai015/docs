...
Complete authentication API documentation for Gistly.
...
<Warning>
  Store access tokens securely. Avoid storing tokens in browser localStorage in production — use HttpOnly cookies or secure token management instead.
</Warning>
